...
import { format, sub, eachDayOfInterval, startOfWeek, endOfWeek } from 'date-fns'
...
export function HabitProgressChart({ completions, habitName }: HabitProgressChartProps) {
    // Prepare weekly data
    ...
    const weeklyData = daysInRange.map((day) => {
        const completion = completions.find(
            (c) => format(new Date(c.completionDate), 'yyyy-MM-dd') === format(day, 'yyyy-MM-dd')
        )
